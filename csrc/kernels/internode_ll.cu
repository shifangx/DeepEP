...
dispatch(void* packed_recv_x, void* packed_recv_x_scales, void* packed_recv_x_sf_scale,
    ...
    // Message package: index at source(int), SF scale for NVFP4(float32), 2 reserved int fields, hidden data, FP8 scales.
    // NOTES: currently we have 2 reserved int fields for future use
